module SimpleNavigation
  ...
  class Item
    attr_reader :key, :url, :sub_navigation, :method, :highlights_on, :disable_item
    ...
    def initialize(container, key, name, url_or_options = {}, options_or_nil={}, items=nil, &sub_nav_block)
      ...
      @name = name
      if (sub_nav_block || items) and not @disable_item
	...
	url = ""
      ...
      @disable_item = @container.should_disable_item?(options)
      case url_or_options
      when Proc
        @url = @disable_item ? "" : url.call
      else
        @url = url
      end
